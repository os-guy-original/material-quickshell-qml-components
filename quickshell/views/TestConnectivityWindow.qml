...
FloatingWindow {
  ...
  UILayout.Container {
    ...
    ColumnLayout {
      spacing: 12
      Type.Label { text: "Connectivity"; pixelSize: 16; color: Components.ColorPalette.onSurface }
      ...
      RowLayout {
        ...
        Type.Label { text: wifi.checked ? "On" : "Off"; color: Components.ColorPalette.onSurfaceVariant }
      }
      RowLayout {
        spacing: 8
        ...
        Inputs.Switch { id: bt }
        Item { Layout.fillWidth: true }
        Type.Label { text: bt.checked ? "On" : "Off"; color: Components.ColorPalette.onSurfaceVariant }
      }
    }
  }
}
